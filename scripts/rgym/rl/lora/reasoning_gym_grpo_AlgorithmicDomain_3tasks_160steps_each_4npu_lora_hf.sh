...
# Usage:
#   bash scripts/rgym/rl/lora/reasoning_gym_grpo_AlgorithmicDomain_3tasks_160steps_each_4npu_lora_hf.sh
set -euo pipefail
...
for task in "${TASKS[@]}"; do
  ...
  LOG_PATH="logs/rl_4npu_algorithmicdomain_${task}_160steps_lora_${DATE_TIME}.log"
